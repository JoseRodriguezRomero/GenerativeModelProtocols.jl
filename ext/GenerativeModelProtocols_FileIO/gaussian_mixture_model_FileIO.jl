function GenerativeModelProtocols.load_gaussian_mixture_parameters(saved_model::String; 
    ...
    return GenerativeModelProtocols.load_gaussian_mixture_parameters(FileIO.query(saved_model);
