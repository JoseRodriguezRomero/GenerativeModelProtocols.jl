...
p = scatter(x_test, y_test, label="input",frame=:box, markersize = 4)
scatter!(recon_test_data[1,:], recon_test_data[2,:], label="reconstruction", frame=:box, legend = :top, markersize = 2)
